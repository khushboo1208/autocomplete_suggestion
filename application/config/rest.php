...
|
*/
// Added to switch dbs for REST API

$active_group = ( strcmp(ENVIRONMENT, 'production') === 0 )? 'default': ( ( strripos($_SERVER["HTTP_HOST"], 'local') !== FALSE)? 'local': 'dev');
...
/*
|--------------------------------------------------------------------------
| REST API Key From Code
|--------------------------------------------------------------------------
|
| To save multiple hits on db for API-KEY
|
| Default: X-API-KEY
|
*/
$config['rest_key_in_code'] = ['654316f09c36b76a8840220ae818c577c5'];
/*
|--------------------------------------------------------------------------
...
/*
|--------------------------------------------------------------------------
| REST resdhift save data
|--------------------------------------------------------------------------
|
| Set to TRUE to save data to Redshift. If TRUE then it save data to Redshift. This is good for production
| environments. Set to FALSE to not to save data.
|
|	FALSE
|
*/
$config['save_data_to_redshift'] = FALSE;
